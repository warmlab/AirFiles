...
NSString * const kDataManagerBundleName = @"AirFiles";
NSString * const kDataManagerModelName = @"AirFiles";
NSString * const kDataManagerSQLiteName = @"AirFiles.sqlite";
